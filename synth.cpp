  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float 	fTemp25 = min(1.0f, (0.6f * fRec14[0]));
			...
			float 	fTemp74 = min(1.0f, (0.6f * fRec33[0]));
			int 	iTemp75 = (fVec7[0] >= fRec31[1]);
			int 	iTemp76 = (fRec31[1] <= 0.001f);
			int 	iTemp77 = (((iRec30[1] >= 4)) ? (((iRec30[1] >= 6)) ? ((iTemp76) ? 0 : ((iTemp71) ? 1 : 6)) : (((iRec30[1] >= 5)) ? ((iTemp72) ? 3 : ((iTemp75) ? 4 : 5)) : ((iTemp72) ? 3 : (((fVec7[0] <= fRec31[1])) ? 5 : 4)))) : (((iRec30[1] >= 2)) ? (((iRec30[1] >= 3)) ? (((iTemp72 & iTemp76)) ? 0 : ((iTemp71) ? 1 : 3)) : ((iTemp72) ? 6 : ((iTemp75) ? 4 : 2))) : (((iRec30[1] >= 1)) ? (((fRec31[1] >= min(fTemp74, 1.0f))) ? ((iTemp72) ? 6 : 2) : 1) : ((iTemp71) ? 1 : 0))));
			iRec30[0] = iTemp77;
			...
			float 	fTemp123 = min(1.0f, (0.6f * fRec51[0]));
			int 	iTemp124 = (fVec11[0] >= fRec49[1]);
			int 	iTemp125 = (fRec49[1] <= 0.001f);
			int 	iTemp126 = (((iRec48[1] >= 4)) ? (((iRec48[1] >= 6)) ? ((iTemp125) ? 0 : ((iTemp120) ? 1 : 6)) : (((iRec48[1] >= 5)) ? ((iTemp121) ? 3 : ((iTemp124) ? 4 : 5)) : ((iTemp121) ? 3 : (((fVec11[0] <= fRec49[1])) ? 5 : 4)))) : (((iRec48[1] >= 2)) ? (((iRec48[1] >= 3)) ? (((iTemp121 & iTemp125)) ? 0 : ((iTemp120) ? 1 : 3)) : ((iTemp121) ? 6 : ((iTemp124) ? 4 : 2))) : (((iRec48[1] >= 1)) ? (((fRec49[1] >= min(fTemp123, 1.0f))) ? ((iTemp121) ? 6 : 2) : 1) : ((iTemp120) ? 1 : 0))));
			iRec48[0] = iTemp126;
			...
			float 	fTemp172 = min(1.0f, (0.6f * fRec69[0]));
			int 	iTemp173 = (fVec15[0] >= fRec67[1]);
			int 	iTemp174 = (fRec67[1] <= 0.001f);
			int 	iTemp175 = (((iRec66[1] >= 4)) ? (((iRec66[1] >= 6)) ? ((iTemp174) ? 0 : ((iTemp169) ? 1 : 6)) : (((iRec66[1] >= 5)) ? ((iTemp170) ? 3 : ((iTemp173) ? 4 : 5)) : ((iTemp170) ? 3 : (((fVec15[0] <= fRec67[1])) ? 5 : 4)))) : (((iRec66[1] >= 2)) ? (((iRec66[1] >= 3)) ? (((iTemp170 & iTemp174)) ? 0 : ((iTemp169) ? 1 : 3)) : ((iTemp170) ? 6 : ((iTemp173) ? 4 : 2))) : (((iRec66[1] >= 1)) ? (((fRec67[1] >= min(fTemp172, 1.0f))) ? ((iTemp170) ? 6 : 2) : 1) : ((iTemp169) ? 1 : 0))));
			iRec66[0] = iTemp175;
			...
			float 	fTemp221 = min(1.0f, (0.6f * fRec87[0]));
			int 	iTemp222 = (fVec19[0] >= fRec85[1]);
			int 	iTemp223 = (fRec85[1] <= 0.001f);
			int 	iTemp224 = (((iRec84[1] >= 4)) ? (((iRec84[1] >= 6)) ? ((iTemp223) ? 0 : ((iTemp218) ? 1 : 6)) : (((iRec84[1] >= 5)) ? ((iTemp219) ? 3 : ((iTemp222) ? 4 : 5)) : ((iTemp219) ? 3 : (((fVec19[0] <= fRec85[1])) ? 5 : 4)))) : (((iRec84[1] >= 2)) ? (((iRec84[1] >= 3)) ? (((iTemp219 & iTemp223)) ? 0 : ((iTemp218) ? 1 : 3)) : ((iTemp219) ? 6 : ((iTemp222) ? 4 : 2))) : (((iRec84[1] >= 1)) ? (((fRec85[1] >= min(fTemp221, 1.0f))) ? ((iTemp219) ? 6 : 2) : 1) : ((iTemp218) ? 1 : 0))));
			iRec84[0] = iTemp224;
			...
			float 	fTemp270 = min(1.0f, (0.6f * fRec105[0]));
			int 	iTemp271 = (fVec23[0] >= fRec103[1]);
			int 	iTemp272 = (fRec103[1] <= 0.001f);
			int 	iTemp273 = (((iRec102[1] >= 4)) ? (((iRec102[1] >= 6)) ? ((iTemp272) ? 0 : ((iTemp267) ? 1 : 6)) : (((iRec102[1] >= 5)) ? ((iTemp268) ? 3 : ((iTemp271) ? 4 : 5)) : ((iTemp268) ? 3 : (((fVec23[0] <= fRec103[1])) ? 5 : 4)))) : (((iRec102[1] >= 2)) ? (((iRec102[1] >= 3)) ? (((iTemp268 & iTemp272)) ? 0 : ((iTemp267) ? 1 : 3)) : ((iTemp268) ? 6 : ((iTemp271) ? 4 : 2))) : (((iRec102[1] >= 1)) ? (((fRec103[1] >= min(fTemp270, 1.0f))) ? ((iTemp268) ? 6 : 2) : 1) : ((iTemp267) ? 1 : 0))));
			iRec102[0] = iTemp273;
