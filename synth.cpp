  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fRec14[0] = max((fTemp24 * fRec14[1]), fSlow15);
			fRec15[0] = max((fRec15[1] * fTemp24), fSlow13);
			float 	fTemp25 = (ftbl1[int(((499.5f * (min(1.0f, fRec15[0]) + 1.0f)) + 0.5f))] + ftbl1[int(((499.5f * (min(1.0f, fRec14[0]) + 1.0f)) + 0.5f))]);
			...
			fRec33[0] = max((fTemp74 * fRec33[1]), fSlow32);
			fRec34[0] = max((fRec34[1] * fTemp74), fSlow30);
			float 	fTemp75 = (ftbl1[int(((499.5f * (min(1.0f, fRec34[0]) + 1.0f)) + 0.5f))] + ftbl1[int(((499.5f * (min(1.0f, fRec33[0]) + 1.0f)) + 0.5f))]);
			...
			fRec51[0] = max((fTemp124 * fRec51[1]), fSlow49);
			fRec52[0] = max((fRec52[1] * fTemp124), fSlow47);
			float 	fTemp125 = (ftbl1[int(((499.5f * (min(1.0f, fRec52[0]) + 1.0f)) + 0.5f))] + ftbl1[int(((499.5f * (min(1.0f, fRec51[0]) + 1.0f)) + 0.5f))]);
			...
			fRec69[0] = max((fTemp174 * fRec69[1]), fSlow66);
			fRec70[0] = max((fRec70[1] * fTemp174), fSlow64);
			float 	fTemp175 = (ftbl1[int(((499.5f * (min(1.0f, fRec70[0]) + 1.0f)) + 0.5f))] + ftbl1[int(((499.5f * (min(1.0f, fRec69[0]) + 1.0f)) + 0.5f))]);
			...
			fRec87[0] = max((fTemp224 * fRec87[1]), fSlow83);
			fRec88[0] = max((fRec88[1] * fTemp224), fSlow81);
			float 	fTemp225 = (ftbl1[int(((499.5f * (min(1.0f, fRec88[0]) + 1.0f)) + 0.5f))] + ftbl1[int(((499.5f * (min(1.0f, fRec87[0]) + 1.0f)) + 0.5f))]);
			...
			fRec105[0] = max((fTemp274 * fRec105[1]), fSlow100);
			fRec106[0] = max((fRec106[1] * fTemp274), fSlow98);
			float 	fTemp275 = (ftbl1[int(((499.5f * (min(1.0f, fRec106[0]) + 1.0f)) + 0.5f))] + ftbl1[int(((499.5f * (min(1.0f, fRec105[0]) + 1.0f)) + 0.5f))]);
