...
=======
				float 	fTemp19 = ((0.002002002f * float((iRec11[0] + -1))) + -1.0f);
				output[i] = ((0.0f - (0.5f * (cosf((3.1415927f * fTemp19)) + -1.0f))) * float(((fTemp19 > 0.0f) - (fTemp19 < 0.0f))));
>>>>>>> Stashed changes
				// post processing
				iRec11[1] = iRec11[0];
			}
...
=======
				int 	iTemp32 = int((1.05f * float((iRec21[0] + -1))));
				output[i] = (((iTemp32 >= 11)) ? (((iTemp32 >= 16)) ? (((iTemp32 >= 19)) ? (((iTemp32 >= 20)) ? 0.0f : 0.01f) : (((iTemp32 >= 18)) ? 0.03f : (((iTemp32 >= 17)) ? 0.06f : 0.08f))) : (((iTemp32 >= 14)) ? (((iTemp32 >= 15)) ? 0.1f : 0.12f) : (((iTemp32 >= 13)) ? 0.14f : (((iTemp32 >= 12)) ? 0.16f : 0.19f)))) : (((iTemp32 >= 6)) ? (((iTemp32 >= 9)) ? (((iTemp32 >= 10)) ? 0.22f : 0.26f) : (((iTemp32 >= 8)) ? 0.3f : (((iTemp32 >= 7)) ? 0.35f : 0.4f))) : (((iTemp32 >= 3)) ? (((iTemp32 >= 5)) ? 0.47f : (((iTemp32 >= 4)) ? 0.55f : 0.64f)) : (((iTemp32 >= 2)) ? 0.74f : (((iTemp32 >= 1)) ? 0.86f : 1.0f)))));
>>>>>>> Stashed changes
				// post processing
				iRec21[1] = iRec21[0];
			}
...
=======
				float 	fTemp60 = float((iRec31[0] + -1));
				float 	fTemp61 = (0.002004008f * fTemp60);
				output[i] = (((fTemp61 < 0.5f)) ? ((0.008016032f * fTemp60) + -1.0f) : ((4.0f * (1.0f - fTemp61)) + -1.0f));
>>>>>>> Stashed changes
				// post processing
				iRec31[1] = iRec31[0];
			}
...
=======
			...
			float 	fTemp16 = (1e+01f * fRec10[0]);
			float 	fTemp17 = (fRec8[1] - fConst2);
			float 	fTemp18 = (fConst2 + fRec8[1]);
			fRec8[0] = (((fTemp18 < fTemp16)) ? fTemp18 : (((fTemp17 > fTemp16)) ? fTemp17 : fTemp16));
			float 	fTemp20 = (4.656613e-10f * fTemp9);
			fRec12[0] = (fTemp20 - (fSlow13 * ((fSlow11 * fRec12[2]) + (fSlow9 * fRec12[1]))));
			fVec3[0] = fSlow15;
			int 	iTemp21 = (fSlow17 != (0.9f * fVec3[1]));
			iVec4[0] = iTemp21;
			int 	iTemp22 = ((iVec4[1] <= 0) & (iVec4[0] > 0));
			iRec17[0] = (iRec17[1] + 1);
			int 	iTemp23 = (iRec17[0] + -1);
			iRec16[0] = ((iRec16[1] * (1 - iTemp22)) + (iTemp23 * iTemp22));
			float 	fTemp24 = ftbl0[int(((499.5f * ((((((fConst7 * float((iRec17[0] + (-1 - iRec16[0])))) > 0.5f) & iSlow16)) ? 0.0f : fSlow14) + 1.0f)) + 0.5f))];
			fVec5[0] = fTemp24;
			int 	iTemp25 = (fVec5[0] > 0.003f);
			int 	iTemp26 = (fVec5[0] <= 0.003f);
			float 	fTemp27 = float((iTemp26 | (fVec5[1] >= 0.003f)));
			fRec18[0] = max((fRec18[1] * fTemp27), fSlow17);
			fRec19[0] = max((fTemp27 * fRec19[1]), fSlow18);
			float 	fTemp28 = (min(1.0f, fRec19[0]) + min(1.0f, fRec18[0]));
			int 	iTemp29 = (fVec5[0] >= fRec15[1]);
			int 	iTemp30 = (fRec15[1] <= 0.001f);
			int 	iTemp31 = (((iRec14[1] >= 4)) ? (((iRec14[1] >= 6)) ? ((iTemp30) ? 0 : ((iTemp25) ? 1 : 6)) : (((iRec14[1] >= 5)) ? ((iTemp26) ? 3 : ((iTemp29) ? 4 : 5)) : ((iTemp26) ? 3 : (((fVec5[0] <= fRec15[1])) ? 5 : 4)))) : (((iRec14[1] >= 2)) ? (((iRec14[1] >= 3)) ? (((iTemp26 & iTemp30)) ? 0 : ((iTemp25) ? 1 : 3)) : ((iTemp26) ? 6 : ((iTemp29) ? 4 : 2))) : (((iRec14[1] >= 1)) ? (((fRec15[1] >= min(fTemp28, 1.0f))) ? ((iTemp26) ? 6 : 2) : 1) : ((iTemp25) ? 1 : 0))));
			iRec14[0] = iTemp31;
			float 	fTemp33 = (((iTemp31 >= 4)) ? (((iTemp31 >= 6)) ? fConst0 : fConst19) : (((iTemp31 >= 2)) ? (((iTemp31 >= 3)) ? fConst5 : fConst18) : (((iTemp31 >= 1)) ? fConst17 : 0.0f)));
			int 	iTemp34 = (iRec14[1] != iRec14[2]);
			iVec6[0] = iTemp34;
			int 	iTemp35 = ((iVec6[1] <= 0) & (iVec6[0] > 0));
			iRec22[0] = ((iRec22[1] * (1 - iTemp35)) + (iTemp23 * iTemp35));
			float 	fTemp36 = (2e+01f * (((fTemp33 > 0.0f)) ? (float((iRec17[0] + (-1 - iRec22[0]))) / fTemp33) : 0.0f));
			int 	iTemp37 = int(fTemp36);
			float 	fTemp38 = ftbl1[max(0, int(min(int(iTemp37), 20)))];
			float 	fTemp39 = (fTemp38 + ((fTemp36 - float(iTemp37)) * (ftbl1[max(0, int(min(int((iTemp37 + 1)), 20)))] - fTemp38)));
			iRec23[0] = iRec14[1];
			int 	iTemp40 = (iRec23[1] == iRec14[1]);
			int 	iTemp41 = (iRec14[1] == 0);
			fRec24[0] = ((iTemp41) ? fVec5[0] : ((iTemp40) ? min(min(fRec24[1], fVec5[0]), fRec15[1]) : min(fVec5[0], fRec15[1])));
			fRec25[0] = ((iTemp41) ? fVec5[0] : ((iTemp40) ? max(max(fRec25[1], fVec5[0]), fRec15[1]) : max(fVec5[0], fRec15[1])));
			int 	iTemp42 = (iRec14[1] == 3);
			int 	iTemp43 = (iRec14[1] == 6);
			float 	fTemp44 = (((iRec14[1] == 1)) ? min(1.0f, fTemp28) : ((iTemp41) ? 0.0f : ((iTemp43) ? (fTemp28 * fTemp39) : ((iTemp42) ? (fRec25[0] * fTemp39) : fVec5[0]))));
			float 	fTemp45 = (1.0f / ((iTemp41) ? 0.0001f : (((iTemp42 | iTemp43)) ? (0.04761905f * fTemp33) : fTemp33)));
			float 	fTemp46 = (fRec20[1] - fTemp45);
			float 	fTemp47 = (fRec20[1] + fTemp45);
			fRec20[0] = (((fTemp47 < fTemp44)) ? fTemp47 : (((fTemp46 > fTemp44)) ? fTemp46 : fTemp44));
			fRec15[0] = fRec20[0];
			fRec13[0] = (fRec15[0] - (fConst16 * ((fConst14 * fRec13[2]) + (fConst12 * fRec13[1]))));
			float 	fTemp48 = min(0.99f, (fConst20 * (((3947.8418f * fRec13[0]) + (7895.6836f * fRec13[1])) + (3947.8418f * fRec13[2]))));
			float 	fTemp49 = min(1.0f, (fSlow19 + (((fTemp48 < 0.1f)) ? (1.0f - (1e+01f * fTemp48)) : 0.0f)));
			int 	iTemp50 = (1 - iVec0[1]);
			float 	fTemp51 = ((iTemp50) ? 0.0f : (fSlow21 + fRec28[1]));
			fRec28[0] = (fTemp51 - floorf(fTemp51));
			float 	fTemp52 = (499.0f * fRec28[0]);
			int 	iTemp53 = int(fTemp52);
			int 	iTemp54 = max(0, min(iTemp53, 499));
			float 	fTemp55 = ftbl2[iTemp54];
			int 	iTemp56 = max(0, min((iTemp53 + 1), 499));
			float 	fTemp57 = (fTemp52 - float(iTemp53));
			float 	fTemp58 = float((((fVec5[1] <= 0.003f) & iTemp25) != 1));
			fRec29[0] = max((fTemp58 * fRec29[1]), fSlow22);
			fRec30[0] = max((fRec30[1] * fTemp58), fSlow3);
			float 	fTemp59 = max(min(((0.5f * (fVec5[0] - fTemp48)) + (0.2f - (0.8f * ((iTemp26) ? (2.0f * (((fRec30[0] > fRec29[0])) ? fRec30[0] : (0.0f - fRec29[0]))) : fSlow4)))), 1.0f), 0.0f);
			float 	fTemp62 = ftbl3[iTemp54];
			float 	fTemp63 = (((fTemp62 + (fTemp57 * (ftbl3[iTemp56] - fTemp62))) * (1.0f - fTemp59)) + (fTemp59 * (fTemp55 + (fTemp57 * (ftbl2[iTemp56] - fTemp55)))));
			float 	fTemp64 = (fRec26[1] - fConst22);
			float 	fTemp65 = (fConst22 + fRec26[1]);
			fRec26[0] = (((fTemp65 < fTemp63)) ? fTemp65 : (((fTemp64 > fTemp63)) ? fTemp64 : fTemp63));
			float 	fTemp66 = ((iTemp50) ? 0.0f : (fSlow23 + fRec32[1]));
			fRec32[0] = (fTemp66 - floorf(fTemp66));
			float 	fTemp67 = (499.0f * fRec32[0]);
			int 	iTemp68 = int(fTemp67);
			float 	fTemp69 = ftbl3[max(0, min(iTemp68, 499))];
			float 	fTemp70 = ((iTemp50) ? 0.0f : (fSlow24 + fRec33[1]));
			fRec33[0] = (fTemp70 - floorf(fTemp70));
			float 	fTemp71 = (499.0f * fRec33[0]);
			int 	iTemp72 = int(fTemp71);
			float 	fTemp73 = ftbl2[max(0, min(iTemp72, 499))];
			fRec34[0] = (fTemp20 - (fSlow35 * ((fSlow33 * fRec34[2]) + (fSlow31 * fRec34[1]))));
			fVec7[0] = fSlow37;
			int 	iTemp74 = (fSlow39 != (0.9f * fVec7[1]));
			iVec8[0] = iTemp74;
			int 	iTemp75 = ((iVec8[1] <= 0) & (iVec8[0] > 0));
			iRec38[0] = ((iRec38[1] * (1 - iTemp75)) + (iTemp23 * iTemp75));
			float 	fTemp76 = ftbl0[int(((499.5f * ((((((fConst7 * float((iRec17[0] + (-1 - iRec38[0])))) > 0.5f) & iSlow38)) ? 0.0f : fSlow36) + 1.0f)) + 0.5f))];
			fVec9[0] = fTemp76;
			int 	iTemp77 = (fVec9[0] > 0.003f);
			int 	iTemp78 = (fVec9[0] <= 0.003f);
			float 	fTemp79 = float((iTemp78 | (fVec9[1] >= 0.003f)));
			fRec39[0] = max((fRec39[1] * fTemp79), fSlow39);
			fRec40[0] = max((fTemp79 * fRec40[1]), fSlow40);
			float 	fTemp80 = (min(1.0f, fRec40[0]) + min(1.0f, fRec39[0]));
			int 	iTemp81 = (fVec9[0] >= fRec37[1]);
			int 	iTemp82 = (fRec37[1] <= 0.001f);
			int 	iTemp83 = (((iRec36[1] >= 4)) ? (((iRec36[1] >= 6)) ? ((iTemp82) ? 0 : ((iTemp77) ? 1 : 6)) : (((iRec36[1] >= 5)) ? ((iTemp78) ? 3 : ((iTemp81) ? 4 : 5)) : ((iTemp78) ? 3 : (((fVec9[0] <= fRec37[1])) ? 5 : 4)))) : (((iRec36[1] >= 2)) ? (((iRec36[1] >= 3)) ? (((iTemp78 & iTemp82)) ? 0 : ((iTemp77) ? 1 : 3)) : ((iTemp78) ? 6 : ((iTemp81) ? 4 : 2))) : (((iRec36[1] >= 1)) ? (((fRec37[1] >= min(fTemp80, 1.0f))) ? ((iTemp78) ? 6 : 2) : 1) : ((iTemp77) ? 1 : 0))));
			iRec36[0] = iTemp83;
			float 	fTemp84 = (((iTemp83 >= 4)) ? (((iTemp83 >= 6)) ? fConst0 : fConst19) : (((iTemp83 >= 2)) ? (((iTemp83 >= 3)) ? fConst5 : fConst18) : (((iTemp83 >= 1)) ? fConst17 : 0.0f)));
			int 	iTemp85 = (iRec36[1] != iRec36[2]);
			iVec10[0] = iTemp85;
			int 	iTemp86 = ((iVec10[1] <= 0) & (iVec10[0] > 0));
			iRec42[0] = ((iRec42[1] * (1 - iTemp86)) + (iTemp23 * iTemp86));
			float 	fTemp87 = (2e+01f * (((fTemp84 > 0.0f)) ? (float((iRec17[0] + (-1 - iRec42[0]))) / fTemp84) : 0.0f));
			int 	iTemp88 = int(fTemp87);
			float 	fTemp89 = ftbl1[max(0, int(min(int(iTemp88), 20)))];
			float 	fTemp90 = (fTemp89 + ((fTemp87 - float(iTemp88)) * (ftbl1[max(0, int(min(int((iTemp88 + 1)), 20)))] - fTemp89)));
			iRec43[0] = iRec36[1];
			int 	iTemp91 = (iRec43[1] == iRec36[1]);
			int 	iTemp92 = (iRec36[1] == 0);
			fRec44[0] = ((iTemp92) ? fVec9[0] : ((iTemp91) ? min(min(fRec44[1], fVec9[0]), fRec37[1]) : min(fVec9[0], fRec37[1])));
			fRec45[0] = ((iTemp92) ? fVec9[0] : ((iTemp91) ? max(max(fRec45[1], fVec9[0]), fRec37[1]) : max(fVec9[0], fRec37[1])));
			int 	iTemp93 = (iRec36[1] == 3);
			int 	iTemp94 = (iRec36[1] == 6);
			float 	fTemp95 = (((iRec36[1] == 1)) ? min(1.0f, fTemp80) : ((iTemp92) ? 0.0f : ((iTemp94) ? (fTemp80 * fTemp90) : ((iTemp93) ? (fRec45[0] * fTemp90) : fVec9[0]))));
			float 	fTemp96 = (1.0f / ((iTemp92) ? 0.0001f : (((iTemp93 | iTemp94)) ? (0.04761905f * fTemp84) : fTemp84)));
			float 	fTemp97 = (fRec41[1] - fTemp96);
			float 	fTemp98 = (fRec41[1] + fTemp96);
			fRec41[0] = (((fTemp98 < fTemp95)) ? fTemp98 : (((fTemp97 > fTemp95)) ? fTemp97 : fTemp95));
			fRec37[0] = fRec41[0];
			fRec35[0] = (fRec37[0] - (fConst16 * ((fConst14 * fRec35[2]) + (fConst12 * fRec35[1]))));
			float 	fTemp99 = min(0.99f, (fConst20 * (((3947.8418f * fRec35[0]) + (7895.6836f * fRec35[1])) + (3947.8418f * fRec35[2]))));
			float 	fTemp100 = min(1.0f, (fSlow41 + (((fTemp99 < 0.1f)) ? (1.0f - (1e+01f * fTemp99)) : 0.0f)));
			float 	fTemp101 = ((iTemp50) ? 0.0f : (fSlow43 + fRec47[1]));
			fRec47[0] = (fTemp101 - floorf(fTemp101));
			float 	fTemp102 = (499.0f * fRec47[0]);
			int 	iTemp103 = int(fTemp102);
			int 	iTemp104 = max(0, min(iTemp103, 499));
			float 	fTemp105 = ftbl2[iTemp104];
			int 	iTemp106 = max(0, min((iTemp103 + 1), 499));
			float 	fTemp107 = (fTemp102 - float(iTemp103));
			float 	fTemp108 = float((((fVec9[1] <= 0.003f) & iTemp77) != 1));
			fRec48[0] = max((fTemp108 * fRec48[1]), fSlow44);
			fRec49[0] = max((fRec49[1] * fTemp108), fSlow25);
			float 	fTemp109 = max(min(((0.5f * (fVec9[0] - fTemp99)) + (0.2f - (0.8f * ((iTemp78) ? (2.0f * (((fRec49[0] > fRec48[0])) ? fRec49[0] : (0.0f - fRec48[0]))) : fSlow26)))), 1.0f), 0.0f);
			float 	fTemp110 = ftbl3[iTemp104];
			float 	fTemp111 = (((fTemp110 + (fTemp107 * (ftbl3[iTemp106] - fTemp110))) * (1.0f - fTemp109)) + (fTemp109 * (fTemp105 + (fTemp107 * (ftbl2[iTemp106] - fTemp105)))));
			float 	fTemp112 = (fRec46[1] - fConst22);
			float 	fTemp113 = (fConst22 + fRec46[1]);
			fRec46[0] = (((fTemp113 < fTemp111)) ? fTemp113 : (((fTemp112 > fTemp111)) ? fTemp112 : fTemp111));
			float 	fTemp114 = ((iTemp50) ? 0.0f : (fSlow45 + fRec50[1]));
			fRec50[0] = (fTemp114 - floorf(fTemp114));
			float 	fTemp115 = (499.0f * fRec50[0]);
			int 	iTemp116 = int(fTemp115);
			float 	fTemp117 = ftbl3[max(0, min(iTemp116, 499))];
			float 	fTemp118 = ((iTemp50) ? 0.0f : (fSlow46 + fRec51[1]));
			fRec51[0] = (fTemp118 - floorf(fTemp118));
			float 	fTemp119 = (499.0f * fRec51[0]);
			int 	iTemp120 = int(fTemp119);
			float 	fTemp121 = ftbl2[max(0, min(iTemp120, 499))];
			fRec52[0] = (fTemp20 - (fSlow57 * ((fSlow55 * fRec52[2]) + (fSlow53 * fRec52[1]))));
			fVec11[0] = fSlow59;
			int 	iTemp122 = (fSlow61 != (0.9f * fVec11[1]));
			iVec12[0] = iTemp122;
			int 	iTemp123 = ((iVec12[1] <= 0) & (iVec12[0] > 0));
			iRec56[0] = ((iRec56[1] * (1 - iTemp123)) + (iTemp23 * iTemp123));
			float 	fTemp124 = ftbl0[int(((499.5f * ((((((fConst7 * float((iRec17[0] + (-1 - iRec56[0])))) > 0.5f) & iSlow60)) ? 0.0f : fSlow58) + 1.0f)) + 0.5f))];
			fVec13[0] = fTemp124;
			int 	iTemp125 = (fVec13[0] > 0.003f);
			int 	iTemp126 = (fVec13[0] <= 0.003f);
			float 	fTemp127 = float((iTemp126 | (fVec13[1] >= 0.003f)));
			fRec57[0] = max((fRec57[1] * fTemp127), fSlow61);
			fRec58[0] = max((fTemp127 * fRec58[1]), fSlow62);
			float 	fTemp128 = (min(1.0f, fRec58[0]) + min(1.0f, fRec57[0]));
			int 	iTemp129 = (fVec13[0] >= fRec55[1]);
			int 	iTemp130 = (fRec55[1] <= 0.001f);
			int 	iTemp131 = (((iRec54[1] >= 4)) ? (((iRec54[1] >= 6)) ? ((iTemp130) ? 0 : ((iTemp125) ? 1 : 6)) : (((iRec54[1] >= 5)) ? ((iTemp126) ? 3 : ((iTemp129) ? 4 : 5)) : ((iTemp126) ? 3 : (((fVec13[0] <= fRec55[1])) ? 5 : 4)))) : (((iRec54[1] >= 2)) ? (((iRec54[1] >= 3)) ? (((iTemp126 & iTemp130)) ? 0 : ((iTemp125) ? 1 : 3)) : ((iTemp126) ? 6 : ((iTemp129) ? 4 : 2))) : (((iRec54[1] >= 1)) ? (((fRec55[1] >= min(fTemp128, 1.0f))) ? ((iTemp126) ? 6 : 2) : 1) : ((iTemp125) ? 1 : 0))));
			iRec54[0] = iTemp131;
			float 	fTemp132 = (((iTemp131 >= 4)) ? (((iTemp131 >= 6)) ? fConst0 : fConst19) : (((iTemp131 >= 2)) ? (((iTemp131 >= 3)) ? fConst5 : fConst18) : (((iTemp131 >= 1)) ? fConst17 : 0.0f)));
			int 	iTemp133 = (iRec54[1] != iRec54[2]);
			iVec14[0] = iTemp133;
			int 	iTemp134 = ((iVec14[1] <= 0) & (iVec14[0] > 0));
			iRec60[0] = ((iRec60[1] * (1 - iTemp134)) + (iTemp23 * iTemp134));
			float 	fTemp135 = (2e+01f * (((fTemp132 > 0.0f)) ? (float((iRec17[0] + (-1 - iRec60[0]))) / fTemp132) : 0.0f));
			int 	iTemp136 = int(fTemp135);
			float 	fTemp137 = ftbl1[max(0, int(min(int(iTemp136), 20)))];
			float 	fTemp138 = (fTemp137 + ((fTemp135 - float(iTemp136)) * (ftbl1[max(0, int(min(int((iTemp136 + 1)), 20)))] - fTemp137)));
			iRec61[0] = iRec54[1];
			int 	iTemp139 = (iRec61[1] == iRec54[1]);
			int 	iTemp140 = (iRec54[1] == 0);
			fRec62[0] = ((iTemp140) ? fVec13[0] : ((iTemp139) ? min(min(fRec62[1], fVec13[0]), fRec55[1]) : min(fVec13[0], fRec55[1])));
			fRec63[0] = ((iTemp140) ? fVec13[0] : ((iTemp139) ? max(max(fRec63[1], fVec13[0]), fRec55[1]) : max(fVec13[0], fRec55[1])));
			int 	iTemp141 = (iRec54[1] == 3);
			int 	iTemp142 = (iRec54[1] == 6);
			float 	fTemp143 = (((iRec54[1] == 1)) ? min(1.0f, fTemp128) : ((iTemp140) ? 0.0f : ((iTemp142) ? (fTemp128 * fTemp138) : ((iTemp141) ? (fRec63[0] * fTemp138) : fVec13[0]))));
			float 	fTemp144 = (1.0f / ((iTemp140) ? 0.0001f : (((iTemp141 | iTemp142)) ? (0.04761905f * fTemp132) : fTemp132)));
			float 	fTemp145 = (fRec59[1] - fTemp144);
			float 	fTemp146 = (fRec59[1] + fTemp144);
			fRec59[0] = (((fTemp146 < fTemp143)) ? fTemp146 : (((fTemp145 > fTemp143)) ? fTemp145 : fTemp143));
			fRec55[0] = fRec59[0];
			fRec53[0] = (fRec55[0] - (fConst16 * ((fConst14 * fRec53[2]) + (fConst12 * fRec53[1]))));
			float 	fTemp147 = min(0.99f, (fConst20 * (((3947.8418f * fRec53[0]) + (7895.6836f * fRec53[1])) + (3947.8418f * fRec53[2]))));
			float 	fTemp148 = min(1.0f, (fSlow63 + (((fTemp147 < 0.1f)) ? (1.0f - (1e+01f * fTemp147)) : 0.0f)));
			float 	fTemp149 = ((iTemp50) ? 0.0f : (fSlow65 + fRec65[1]));
			fRec65[0] = (fTemp149 - floorf(fTemp149));
			float 	fTemp150 = (499.0f * fRec65[0]);
			...
			float 	fTemp156 = float((((fVec13[1] <= 0.003f) & iTemp125) != 1));
			fRec66[0] = max((fTemp156 * fRec66[1]), fSlow66);
			fRec67[0] = max((fRec67[1] * fTemp156), fSlow47);
			float 	fTemp157 = max(min(((0.5f * (fVec13[0] - fTemp147)) + (0.2f - (0.8f * ((iTemp126) ? (2.0f * (((fRec67[0] > fRec66[0])) ? fRec67[0] : (0.0f - fRec66[0]))) : fSlow48)))), 1.0f), 0.0f);
			float 	fTemp158 = ftbl3[iTemp152];
			float 	fTemp159 = (((fTemp158 + (fTemp155 * (ftbl3[iTemp154] - fTemp158))) * (1.0f - fTemp157)) + (fTemp157 * (fTemp153 + (fTemp155 * (ftbl2[iTemp154] - fTemp153)))));
			float 	fTemp160 = (fRec64[1] - fConst22);
			float 	fTemp161 = (fConst22 + fRec64[1]);
			fRec64[0] = (((fTemp161 < fTemp159)) ? fTemp161 : (((fTemp160 > fTemp159)) ? fTemp160 : fTemp159));
			float 	fTemp162 = ((iTemp50) ? 0.0f : (fSlow67 + fRec68[1]));
			fRec68[0] = (fTemp162 - floorf(fTemp162));
			float 	fTemp163 = (499.0f * fRec68[0]);
			int 	iTemp164 = int(fTemp163);
			float 	fTemp165 = ftbl3[max(0, min(iTemp164, 499))];
			float 	fTemp166 = ((iTemp50) ? 0.0f : (fSlow68 + fRec69[1]));
			fRec69[0] = (fTemp166 - floorf(fTemp166));
			float 	fTemp167 = (499.0f * fRec69[0]);
			int 	iTemp168 = int(fTemp167);
			float 	fTemp169 = ftbl2[max(0, min(iTemp168, 499))];
			fRec70[0] = (fTemp20 - (fSlow79 * ((fSlow77 * fRec70[2]) + (fSlow75 * fRec70[1]))));
			fVec15[0] = fSlow81;
			int 	iTemp170 = (fSlow83 != (0.9f * fVec15[1]));
			iVec16[0] = iTemp170;
			int 	iTemp171 = ((iVec16[1] <= 0) & (iVec16[0] > 0));
			iRec74[0] = ((iRec74[1] * (1 - iTemp171)) + (iTemp23 * iTemp171));
			float 	fTemp172 = ftbl0[int(((499.5f * ((((((fConst7 * float((iRec17[0] + (-1 - iRec74[0])))) > 0.5f) & iSlow82)) ? 0.0f : fSlow80) + 1.0f)) + 0.5f))];
			fVec17[0] = fTemp172;
			int 	iTemp173 = (fVec17[0] > 0.003f);
			int 	iTemp174 = (fVec17[0] <= 0.003f);
			float 	fTemp175 = float((iTemp174 | (fVec17[1] >= 0.003f)));
			fRec75[0] = max((fRec75[1] * fTemp175), fSlow83);
			fRec76[0] = max((fTemp175 * fRec76[1]), fSlow84);
			float 	fTemp176 = (min(1.0f, fRec76[0]) + min(1.0f, fRec75[0]));
			int 	iTemp177 = (fVec17[0] >= fRec73[1]);
			int 	iTemp178 = (fRec73[1] <= 0.001f);
			int 	iTemp179 = (((iRec72[1] >= 4)) ? (((iRec72[1] >= 6)) ? ((iTemp178) ? 0 : ((iTemp173) ? 1 : 6)) : (((iRec72[1] >= 5)) ? ((iTemp174) ? 3 : ((iTemp177) ? 4 : 5)) : ((iTemp174) ? 3 : (((fVec17[0] <= fRec73[1])) ? 5 : 4)))) : (((iRec72[1] >= 2)) ? (((iRec72[1] >= 3)) ? (((iTemp174 & iTemp178)) ? 0 : ((iTemp173) ? 1 : 3)) : ((iTemp174) ? 6 : ((iTemp177) ? 4 : 2))) : (((iRec72[1] >= 1)) ? (((fRec73[1] >= min(fTemp176, 1.0f))) ? ((iTemp174) ? 6 : 2) : 1) : ((iTemp173) ? 1 : 0))));
			iRec72[0] = iTemp179;
			float 	fTemp180 = (((iTemp179 >= 4)) ? (((iTemp179 >= 6)) ? fConst0 : fConst19) : (((iTemp179 >= 2)) ? (((iTemp179 >= 3)) ? fConst5 : fConst18) : (((iTemp179 >= 1)) ? fConst17 : 0.0f)));
			int 	iTemp181 = (iRec72[1] != iRec72[2]);
			iVec18[0] = iTemp181;
			int 	iTemp182 = ((iVec18[1] <= 0) & (iVec18[0] > 0));
			iRec78[0] = ((iRec78[1] * (1 - iTemp182)) + (iTemp23 * iTemp182));
			float 	fTemp183 = (2e+01f * (((fTemp180 > 0.0f)) ? (float((iRec17[0] + (-1 - iRec78[0]))) / fTemp180) : 0.0f));
			int 	iTemp184 = int(fTemp183);
			float 	fTemp185 = ftbl1[max(0, int(min(int(iTemp184), 20)))];
			float 	fTemp186 = (fTemp185 + ((fTemp183 - float(iTemp184)) * (ftbl1[max(0, int(min(int((iTemp184 + 1)), 20)))] - fTemp185)));
			iRec79[0] = iRec72[1];
			int 	iTemp187 = (iRec79[1] == iRec72[1]);
			int 	iTemp188 = (iRec72[1] == 0);
			fRec80[0] = ((iTemp188) ? fVec17[0] : ((iTemp187) ? min(min(fRec80[1], fVec17[0]), fRec73[1]) : min(fVec17[0], fRec73[1])));
			fRec81[0] = ((iTemp188) ? fVec17[0] : ((iTemp187) ? max(max(fRec81[1], fVec17[0]), fRec73[1]) : max(fVec17[0], fRec73[1])));
			int 	iTemp189 = (iRec72[1] == 3);
			int 	iTemp190 = (iRec72[1] == 6);
			float 	fTemp191 = (((iRec72[1] == 1)) ? min(1.0f, fTemp176) : ((iTemp188) ? 0.0f : ((iTemp190) ? (fTemp176 * fTemp186) : ((iTemp189) ? (fRec81[0] * fTemp186) : fVec17[0]))));
			float 	fTemp192 = (1.0f / ((iTemp188) ? 0.0001f : (((iTemp189 | iTemp190)) ? (0.04761905f * fTemp180) : fTemp180)));
			float 	fTemp193 = (fRec77[1] - fTemp192);
			float 	fTemp194 = (fRec77[1] + fTemp192);
			fRec77[0] = (((fTemp194 < fTemp191)) ? fTemp194 : (((fTemp193 > fTemp191)) ? fTemp193 : fTemp191));
			fRec73[0] = fRec77[0];
			fRec71[0] = (fRec73[0] - (fConst16 * ((fConst14 * fRec71[2]) + (fConst12 * fRec71[1]))));
			float 	fTemp195 = min(0.99f, (fConst20 * (((3947.8418f * fRec71[0]) + (7895.6836f * fRec71[1])) + (3947.8418f * fRec71[2]))));
			float 	fTemp196 = min(1.0f, (fSlow85 + (((fTemp195 < 0.1f)) ? (1.0f - (1e+01f * fTemp195)) : 0.0f)));
			float 	fTemp197 = ((iTemp50) ? 0.0f : (fSlow87 + fRec83[1]));
			fRec83[0] = (fTemp197 - floorf(fTemp197));
			float 	fTemp198 = (499.0f * fRec83[0]);
			int 	iTemp199 = int(fTemp198);
			int 	iTemp200 = max(0, min(iTemp199, 499));
			float 	fTemp201 = ftbl2[iTemp200];
			int 	iTemp202 = max(0, min((iTemp199 + 1), 499));
			float 	fTemp203 = (fTemp198 - float(iTemp199));
			float 	fTemp204 = float((((fVec17[1] <= 0.003f) & iTemp173) != 1));
			fRec84[0] = max((fTemp204 * fRec84[1]), fSlow88);
			fRec85[0] = max((fRec85[1] * fTemp204), fSlow69);
			float 	fTemp205 = max(min(((0.5f * (fVec17[0] - fTemp195)) + (0.2f - (0.8f * ((iTemp174) ? (2.0f * (((fRec85[0] > fRec84[0])) ? fRec85[0] : (0.0f - fRec84[0]))) : fSlow70)))), 1.0f), 0.0f);
			float 	fTemp206 = ftbl3[iTemp200];
			float 	fTemp207 = (((fTemp206 + (fTemp203 * (ftbl3[iTemp202] - fTemp206))) * (1.0f - fTemp205)) + (fTemp205 * (fTemp201 + (fTemp203 * (ftbl2[iTemp202] - fTemp201)))));
			float 	fTemp208 = (fRec82[1] - fConst22);
			float 	fTemp209 = (fConst22 + fRec82[1]);
			fRec82[0] = (((fTemp209 < fTemp207)) ? fTemp209 : (((fTemp208 > fTemp207)) ? fTemp208 : fTemp207));
			float 	fTemp210 = ((iTemp50) ? 0.0f : (fSlow89 + fRec86[1]));
			fRec86[0] = (fTemp210 - floorf(fTemp210));
			float 	fTemp211 = (499.0f * fRec86[0]);
			int 	iTemp212 = int(fTemp211);
			float 	fTemp213 = ftbl3[max(0, min(iTemp212, 499))];
			float 	fTemp214 = ((iTemp50) ? 0.0f : (fSlow90 + fRec87[1]));
			fRec87[0] = (fTemp214 - floorf(fTemp214));
			float 	fTemp215 = (499.0f * fRec87[0]);
			int 	iTemp216 = int(fTemp215);
			float 	fTemp217 = ftbl2[max(0, min(iTemp216, 499))];
			fRec88[0] = (fTemp20 - (fSlow101 * ((fSlow99 * fRec88[2]) + (fSlow97 * fRec88[1]))));
			fVec19[0] = fSlow103;
			int 	iTemp218 = (fSlow105 != (0.9f * fVec19[1]));
			iVec20[0] = iTemp218;
			int 	iTemp219 = ((iVec20[1] <= 0) & (iVec20[0] > 0));
			iRec92[0] = ((iRec92[1] * (1 - iTemp219)) + (iTemp23 * iTemp219));
			float 	fTemp220 = ftbl0[int(((499.5f * ((((((fConst7 * float((iRec17[0] + (-1 - iRec92[0])))) > 0.5f) & iSlow104)) ? 0.0f : fSlow102) + 1.0f)) + 0.5f))];
			fVec21[0] = fTemp220;
			int 	iTemp221 = (fVec21[0] > 0.003f);
			int 	iTemp222 = (fVec21[0] <= 0.003f);
			float 	fTemp223 = float((iTemp222 | (fVec21[1] >= 0.003f)));
			fRec93[0] = max((fRec93[1] * fTemp223), fSlow105);
			fRec94[0] = max((fTemp223 * fRec94[1]), fSlow106);
			float 	fTemp224 = (min(1.0f, fRec94[0]) + min(1.0f, fRec93[0]));
			int 	iTemp225 = (fVec21[0] >= fRec91[1]);
			int 	iTemp226 = (fRec91[1] <= 0.001f);
			int 	iTemp227 = (((iRec90[1] >= 4)) ? (((iRec90[1] >= 6)) ? ((iTemp226) ? 0 : ((iTemp221) ? 1 : 6)) : (((iRec90[1] >= 5)) ? ((iTemp222) ? 3 : ((iTemp225) ? 4 : 5)) : ((iTemp222) ? 3 : (((fVec21[0] <= fRec91[1])) ? 5 : 4)))) : (((iRec90[1] >= 2)) ? (((iRec90[1] >= 3)) ? (((iTemp222 & iTemp226)) ? 0 : ((iTemp221) ? 1 : 3)) : ((iTemp222) ? 6 : ((iTemp225) ? 4 : 2))) : (((iRec90[1] >= 1)) ? (((fRec91[1] >= min(fTemp224, 1.0f))) ? ((iTemp222) ? 6 : 2) : 1) : ((iTemp221) ? 1 : 0))));
			iRec90[0] = iTemp227;
			float 	fTemp228 = (((iTemp227 >= 4)) ? (((iTemp227 >= 6)) ? fConst0 : fConst19) : (((iTemp227 >= 2)) ? (((iTemp227 >= 3)) ? fConst5 : fConst18) : (((iTemp227 >= 1)) ? fConst17 : 0.0f)));
			int 	iTemp229 = (iRec90[1] != iRec90[2]);
			iVec22[0] = iTemp229;
			int 	iTemp230 = ((iVec22[1] <= 0) & (iVec22[0] > 0));
			iRec96[0] = ((iRec96[1] * (1 - iTemp230)) + (iTemp23 * iTemp230));
			float 	fTemp231 = (2e+01f * (((fTemp228 > 0.0f)) ? (float((iRec17[0] + (-1 - iRec96[0]))) / fTemp228) : 0.0f));
			int 	iTemp232 = int(fTemp231);
			float 	fTemp233 = ftbl1[max(0, int(min(int(iTemp232), 20)))];
			float 	fTemp234 = (fTemp233 + ((fTemp231 - float(iTemp232)) * (ftbl1[max(0, int(min(int((iTemp232 + 1)), 20)))] - fTemp233)));
			iRec97[0] = iRec90[1];
			int 	iTemp235 = (iRec97[1] == iRec90[1]);
			int 	iTemp236 = (iRec90[1] == 0);
			fRec98[0] = ((iTemp236) ? fVec21[0] : ((iTemp235) ? min(min(fRec98[1], fVec21[0]), fRec91[1]) : min(fVec21[0], fRec91[1])));
			fRec99[0] = ((iTemp236) ? fVec21[0] : ((iTemp235) ? max(max(fRec99[1], fVec21[0]), fRec91[1]) : max(fVec21[0], fRec91[1])));
			int 	iTemp237 = (iRec90[1] == 3);
			int 	iTemp238 = (iRec90[1] == 6);
			float 	fTemp239 = (((iRec90[1] == 1)) ? min(1.0f, fTemp224) : ((iTemp236) ? 0.0f : ((iTemp238) ? (fTemp224 * fTemp234) : ((iTemp237) ? (fRec99[0] * fTemp234) : fVec21[0]))));
			float 	fTemp240 = (1.0f / ((iTemp236) ? 0.0001f : (((iTemp237 | iTemp238)) ? (0.04761905f * fTemp228) : fTemp228)));
			float 	fTemp241 = (fRec95[1] - fTemp240);
			float 	fTemp242 = (fRec95[1] + fTemp240);
			fRec95[0] = (((fTemp242 < fTemp239)) ? fTemp242 : (((fTemp241 > fTemp239)) ? fTemp241 : fTemp239));
			fRec91[0] = fRec95[0];
			fRec89[0] = (fRec91[0] - (fConst16 * ((fConst14 * fRec89[2]) + (fConst12 * fRec89[1]))));
			float 	fTemp243 = min(0.99f, (fConst20 * (((3947.8418f * fRec89[0]) + (7895.6836f * fRec89[1])) + (3947.8418f * fRec89[2]))));
			float 	fTemp244 = min(1.0f, (fSlow107 + (((fTemp243 < 0.1f)) ? (1.0f - (1e+01f * fTemp243)) : 0.0f)));
			float 	fTemp245 = ((iTemp50) ? 0.0f : (fSlow109 + fRec101[1]));
			fRec101[0] = (fTemp245 - floorf(fTemp245));
			float 	fTemp246 = (499.0f * fRec101[0]);
			int 	iTemp247 = int(fTemp246);
			int 	iTemp248 = max(0, min(iTemp247, 499));
			float 	fTemp249 = ftbl2[iTemp248];
			int 	iTemp250 = max(0, min((iTemp247 + 1), 499));
			float 	fTemp251 = (fTemp246 - float(iTemp247));
			float 	fTemp252 = float((((fVec21[1] <= 0.003f) & iTemp221) != 1));
			fRec102[0] = max((fTemp252 * fRec102[1]), fSlow110);
			fRec103[0] = max((fRec103[1] * fTemp252), fSlow91);
			float 	fTemp253 = max(min(((0.5f * (fVec21[0] - fTemp243)) + (0.2f - (0.8f * ((iTemp222) ? (2.0f * (((fRec103[0] > fRec102[0])) ? fRec103[0] : (0.0f - fRec102[0]))) : fSlow92)))), 1.0f), 0.0f);
			float 	fTemp254 = ftbl3[iTemp248];
			float 	fTemp255 = (((fTemp254 + (fTemp251 * (ftbl3[iTemp250] - fTemp254))) * (1.0f - fTemp253)) + (fTemp253 * (fTemp249 + (fTemp251 * (ftbl2[iTemp250] - fTemp249)))));
			float 	fTemp256 = (fRec100[1] - fConst22);
			float 	fTemp257 = (fConst22 + fRec100[1]);
			fRec100[0] = (((fTemp257 < fTemp255)) ? fTemp257 : (((fTemp256 > fTemp255)) ? fTemp256 : fTemp255));
			float 	fTemp258 = ((iTemp50) ? 0.0f : (fSlow111 + fRec104[1]));
			fRec104[0] = (fTemp258 - floorf(fTemp258));
			float 	fTemp259 = (499.0f * fRec104[0]);
			int 	iTemp260 = int(fTemp259);
			float 	fTemp261 = ftbl3[max(0, min(iTemp260, 499))];
			float 	fTemp262 = ((iTemp50) ? 0.0f : (fSlow112 + fRec105[1]));
			fRec105[0] = (fTemp262 - floorf(fTemp262));
			float 	fTemp263 = (499.0f * fRec105[0]);
			int 	iTemp264 = int(fTemp263);
			float 	fTemp265 = ftbl2[max(0, min(iTemp264, 499))];
			fRec106[0] = (fTemp20 - (fSlow123 * ((fSlow121 * fRec106[2]) + (fSlow119 * fRec106[1]))));
			fVec23[0] = fSlow125;
			int 	iTemp266 = (fSlow127 != (0.9f * fVec23[1]));
			iVec24[0] = iTemp266;
			int 	iTemp267 = ((iVec24[1] <= 0) & (iVec24[0] > 0));
			iRec110[0] = ((iRec110[1] * (1 - iTemp267)) + (iTemp23 * iTemp267));
			float 	fTemp268 = ftbl0[int(((499.5f * ((((((fConst7 * float((iRec17[0] + (-1 - iRec110[0])))) > 0.5f) & iSlow126)) ? 0.0f : fSlow124) + 1.0f)) + 0.5f))];
			fVec25[0] = fTemp268;
			int 	iTemp269 = (fVec25[0] > 0.003f);
			int 	iTemp270 = (fVec25[0] <= 0.003f);
			float 	fTemp271 = float((iTemp270 | (fVec25[1] >= 0.003f)));
			fRec111[0] = max((fRec111[1] * fTemp271), fSlow127);
			fRec112[0] = max((fTemp271 * fRec112[1]), fSlow128);
			float 	fTemp272 = (min(1.0f, fRec112[0]) + min(1.0f, fRec111[0]));
			int 	iTemp273 = (fVec25[0] >= fRec109[1]);
			int 	iTemp274 = (fRec109[1] <= 0.001f);
			int 	iTemp275 = (((iRec108[1] >= 4)) ? (((iRec108[1] >= 6)) ? ((iTemp274) ? 0 : ((iTemp269) ? 1 : 6)) : (((iRec108[1] >= 5)) ? ((iTemp270) ? 3 : ((iTemp273) ? 4 : 5)) : ((iTemp270) ? 3 : (((fVec25[0] <= fRec109[1])) ? 5 : 4)))) : (((iRec108[1] >= 2)) ? (((iRec108[1] >= 3)) ? (((iTemp270 & iTemp274)) ? 0 : ((iTemp269) ? 1 : 3)) : ((iTemp270) ? 6 : ((iTemp273) ? 4 : 2))) : (((iRec108[1] >= 1)) ? (((fRec109[1] >= min(fTemp272, 1.0f))) ? ((iTemp270) ? 6 : 2) : 1) : ((iTemp269) ? 1 : 0))));
			iRec108[0] = iTemp275;
			float 	fTemp276 = (((iTemp275 >= 4)) ? (((iTemp275 >= 6)) ? fConst0 : fConst19) : (((iTemp275 >= 2)) ? (((iTemp275 >= 3)) ? fConst5 : fConst18) : (((iTemp275 >= 1)) ? fConst17 : 0.0f)));
			int 	iTemp277 = (iRec108[1] != iRec108[2]);
			iVec26[0] = iTemp277;
			int 	iTemp278 = ((iVec26[1] <= 0) & (iVec26[0] > 0));
			iRec114[0] = ((iRec114[1] * (1 - iTemp278)) + (iTemp23 * iTemp278));
			float 	fTemp279 = (2e+01f * (((fTemp276 > 0.0f)) ? (float((iRec17[0] + (-1 - iRec114[0]))) / fTemp276) : 0.0f));
			int 	iTemp280 = int(fTemp279);
			float 	fTemp281 = ftbl1[max(0, int(min(int(iTemp280), 20)))];
			float 	fTemp282 = (fTemp281 + ((fTemp279 - float(iTemp280)) * (ftbl1[max(0, int(min(int((iTemp280 + 1)), 20)))] - fTemp281)));
			iRec115[0] = iRec108[1];
			int 	iTemp283 = (iRec115[1] == iRec108[1]);
			int 	iTemp284 = (iRec108[1] == 0);
			fRec116[0] = ((iTemp284) ? fVec25[0] : ((iTemp283) ? min(min(fRec116[1], fVec25[0]), fRec109[1]) : min(fVec25[0], fRec109[1])));
			fRec117[0] = ((iTemp284) ? fVec25[0] : ((iTemp283) ? max(max(fRec117[1], fVec25[0]), fRec109[1]) : max(fVec25[0], fRec109[1])));
			int 	iTemp285 = (iRec108[1] == 3);
			int 	iTemp286 = (iRec108[1] == 6);
			float 	fTemp287 = (((iRec108[1] == 1)) ? min(1.0f, fTemp272) : ((iTemp284) ? 0.0f : ((iTemp286) ? (fTemp272 * fTemp282) : ((iTemp285) ? (fRec117[0] * fTemp282) : fVec25[0]))));
			float 	fTemp288 = (1.0f / ((iTemp284) ? 0.0001f : (((iTemp285 | iTemp286)) ? (0.04761905f * fTemp276) : fTemp276)));
			float 	fTemp289 = (fRec113[1] - fTemp288);
			float 	fTemp290 = (fRec113[1] + fTemp288);
			fRec113[0] = (((fTemp290 < fTemp287)) ? fTemp290 : (((fTemp289 > fTemp287)) ? fTemp289 : fTemp287));
			fRec109[0] = fRec113[0];
			fRec107[0] = (fRec109[0] - (fConst16 * ((fConst14 * fRec107[2]) + (fConst12 * fRec107[1]))));
			float 	fTemp291 = min(0.99f, (fConst20 * (((3947.8418f * fRec107[0]) + (7895.6836f * fRec107[1])) + (3947.8418f * fRec107[2]))));
			float 	fTemp292 = min(1.0f, (fSlow129 + (((fTemp291 < 0.1f)) ? (1.0f - (1e+01f * fTemp291)) : 0.0f)));
			float 	fTemp293 = ((iTemp50) ? 0.0f : (fSlow131 + fRec119[1]));
			fRec119[0] = (fTemp293 - floorf(fTemp293));
			float 	fTemp294 = (499.0f * fRec119[0]);
			int 	iTemp295 = int(fTemp294);
			int 	iTemp296 = max(0, min(iTemp295, 499));
			float 	fTemp297 = ftbl2[iTemp296];
			int 	iTemp298 = max(0, min((iTemp295 + 1), 499));
			float 	fTemp299 = (fTemp294 - float(iTemp295));
			float 	fTemp300 = float((((fVec25[1] <= 0.003f) & iTemp269) != 1));
			fRec120[0] = max((fTemp300 * fRec120[1]), fSlow132);
			fRec121[0] = max((fRec121[1] * fTemp300), fSlow113);
			float 	fTemp301 = max(min(((0.5f * (fVec25[0] - fTemp291)) + (0.2f - (0.8f * ((iTemp270) ? (2.0f * (((fRec121[0] > fRec120[0])) ? fRec121[0] : (0.0f - fRec120[0]))) : fSlow114)))), 1.0f), 0.0f);
			float 	fTemp302 = ftbl3[iTemp296];
			float 	fTemp303 = (((fTemp302 + (fTemp299 * (ftbl3[iTemp298] - fTemp302))) * (1.0f - fTemp301)) + (fTemp301 * (fTemp297 + (fTemp299 * (ftbl2[iTemp298] - fTemp297)))));
			float 	fTemp304 = (fRec118[1] - fConst22);
			float 	fTemp305 = (fConst22 + fRec118[1]);
			fRec118[0] = (((fTemp305 < fTemp303)) ? fTemp305 : (((fTemp304 > fTemp303)) ? fTemp304 : fTemp303));
			float 	fTemp306 = ((iTemp50) ? 0.0f : (fSlow133 + fRec122[1]));
			fRec122[0] = (fTemp306 - floorf(fTemp306));
			float 	fTemp307 = (499.0f * fRec122[0]);
			int 	iTemp308 = int(fTemp307);
			float 	fTemp309 = ftbl3[max(0, min(iTemp308, 499))];
			float 	fTemp310 = ((iTemp50) ? 0.0f : (fSlow134 + fRec123[1]));
			fRec123[0] = (fTemp310 - floorf(fTemp310));
			float 	fTemp311 = (499.0f * fRec123[0]);
			int 	iTemp312 = int(fTemp311);
			float 	fTemp313 = ftbl2[max(0, min(iTemp312, 499))];
			output0[i] = (FAUSTFLOAT)((((((((fTemp291 * ((0.5f * ((((0.2f * (fTemp313 + ((fTemp311 - float(iTemp312)) * (ftbl2[max(0, min((iTemp312 + 1), 499))] - fTemp313)))) + (0.8f * (fTemp309 + ((fTemp307 - float(iTemp308)) * (ftbl3[max(0, min((iTemp308 + 1), 499))] - fTemp309))))) * fSlow117) * fSlow115)) + (((fRec118[0] * (1.0f - fTemp292)) + (fSlow130 * (fTemp292 * (fRec106[0] - fRec106[2])))) * fSlow118))) + (fTemp243 * ((0.5f * ((((0.2f * (fTemp265 + ((fTemp263 - float(iTemp264)) * (ftbl2[max(0, min((iTemp264 + 1), 499))] - fTemp265)))) + (0.8f * (fTemp261 + ((fTemp259 - float(iTemp260)) * (ftbl3[max(0, min((iTemp260 + 1), 499))] - fTemp261))))) * fSlow95) * fSlow93)) + (((fRec100[0] * (1.0f - fTemp244)) + (fSlow108 * (fTemp244 * (fRec88[0] - fRec88[2])))) * fSlow96)))) + (fTemp195 * ((0.5f * ((((0.2f * (fTemp217 + ((fTemp215 - float(iTemp216)) * (ftbl2[max(0, min((iTemp216 + 1), 499))] - fTemp217)))) + (0.8f * (fTemp213 + ((fTemp211 - float(iTemp212)) * (ftbl3[max(0, min((iTemp212 + 1), 499))] - fTemp213))))) * fSlow73) * fSlow71)) + (((fRec82[0] * (1.0f - fTemp196)) + (fSlow86 * (fTemp196 * (fRec70[0] - fRec70[2])))) * fSlow74)))) + (fTemp147 * ((0.5f * ((((0.2f * (fTemp169 + ((fTemp167 - float(iTemp168)) * (ftbl2[max(0, min((iTemp168 + 1), 499))] - fTemp169)))) + (0.8f * (fTemp165 + ((fTemp163 - float(iTemp164)) * (ftbl3[max(0, min((iTemp164 + 1), 499))] - fTemp165))))) * fSlow51) * fSlow49)) + (((fRec64[0] * (1.0f - fTemp148)) + (fSlow64 * (fTemp148 * (fRec52[0] - fRec52[2])))) * fSlow52)))) + (fTemp99 * ((0.5f * ((((0.2f * (fTemp121 + ((fTemp119 - float(iTemp120)) * (ftbl2[max(0, min((iTemp120 + 1), 499))] - fTemp121)))) + (0.8f * (fTemp117 + ((fTemp115 - float(iTemp116)) * (ftbl3[max(0, min((iTemp116 + 1), 499))] - fTemp117))))) * fSlow29) * fSlow27)) + (((fRec46[0] * (1.0f - fTemp100)) + (fSlow42 * (fTemp100 * (fRec34[0] - fRec34[2])))) * fSlow30)))) + (fTemp48 * ((0.5f * ((((0.2f * (fTemp73 + ((fTemp71 - float(iTemp72)) * (ftbl2[max(0, min((iTemp72 + 1), 499))] - fTemp73)))) + (0.8f * (fTemp69 + ((fTemp67 - float(iTemp68)) * (ftbl3[max(0, min((iTemp68 + 1), 499))] - fTemp69))))) * fSlow7) * fSlow5)) + (((fRec26[0] * (1.0f - fTemp49)) + (fSlow20 * (fTemp49 * (fRec12[0] - fRec12[2])))) * fSlow8)))) + (1.6129032e-06f * ((((fRec8[0] * fRec0[0]) * (fRec4[0] - fRec4[2])) * max(0.0f, min((fConst4 * fTemp8), ((fConst6 * (fConst3 - fTemp8)) + 1.0f)))) / fTemp5))));
>>>>>>> Stashed changes
			// post processing
