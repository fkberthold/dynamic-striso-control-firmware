...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		int 	iSlow53 = ((int((fSlow50 >= 0.01f)))?1:0);
		...
		int 	iSlow70 = ((int((fSlow67 >= 0.01f)))?1:0);
		...
		int 	iSlow87 = ((int((fSlow84 >= 0.01f)))?1:0);
		...
		int 	iSlow104 = ((int((fSlow101 >= 0.01f)))?1:0);
		...
		int 	iSlow109 = int((fSlow101 <= 0.01f));
		...
		int 	iSlow121 = ((int((fSlow118 >= 0.01f)))?1:0);
		...
		int 	iSlow126 = int((fSlow118 <= 0.01f));
		...
		for (int i=0; i<count; i++) {
			...
			float 	fTemp18 = ((iTemp17)?1.7f:((iTemp16)?1.3f:1.0f));
			iRec17[0] = iRec13[1];
			...
			fbargraph1 = ((iTemp30)?((iTemp29)?((iSlow40)?3:((iTemp25)?5:6)):((iTemp28)?((iSlow40)?3:((int((fSlow32 <= fRec14[1])))?6:5)):((int((fRec14[1] <= 0.01f)))?0:4))):((iTemp27)?((iTemp26)?((int((iSlow42 & (fRec14[1] <= 0.0f))))?0:((int((fSlow32 > fRec14[1])))?4:3)):((iTemp25)?5:iSlow41)):((iTemp24)?((int(((float((iRec22[0] + (-1 - iRec21[0]))) >= fConst33) & (fRec14[1] >= (fbargraph0 * fTemp18)))))?2:1):iSlow35)));
			iRec13[0] = fbargraph1;
			float 	fTemp31 = ((iTemp22)?fTemp21:fSlow32);
			float 	fTemp32 = ((iTemp30)?((iTemp29)?fConst0:((iTemp28)?fConst0:fConst35)):((iTemp27)?((iTemp26)?fConst0:fConst33):((iTemp24)?fConst34:0.0f)));
			float 	fTemp33 = fabsf(fRec15[0]);
			fbargraph2 = ((fTemp33 * ((iTemp17)?((iTemp30)?((iTemp29)?fConst38:((iTemp28)?fConst38:fConst35)):((iTemp27)?((iTemp26)?fConst37:fConst36):((iTemp24)?fConst36:0.0f))):((iTemp16)?fTemp32:((iTemp30)?fConst35:((iTemp27)?fConst35:((iTemp24)?fConst35:0.0f)))))) + ((1.0f - fTemp33) * fTemp32));
			...
			float 	fTemp39 = tanf((fConst32 * min((fSlow44 * (faustpower<2>((fTemp38 + (fConst31 * (fTemp37 * (1.0f - fTemp11))))) + 1.0f)), (float)16000)));
			...
			float 	fTemp46 = (fTemp45 + ((fRec28[0] - float(iTemp44)) * (ftbl0[((iTemp44 + 1) % iSlow46)] - fTemp45)));
			...
			float 	fTemp50 = tanf((fConst32 * ((fSlow51 * (fTemp47 * fTemp49)) + 200.0f)));
			...
			float 	fTemp56 = (1.0f / ((int((iSlow57 == ((fRec41[1] > 0.0f) - (fRec41[1] < 0.0f)))))?((int((fSlow55 >= fabsf(fRec41[1]))))?fConst33:fConst0):fSlow56));
			float 	fTemp57 = (fRec42[1] - fTemp56);
			float 	fTemp58 = (fRec42[1] + fTemp56);
			fRec42[0] = ((int((fTemp58 < fSlow54)))?fTemp58:((int((fTemp57 > fSlow54)))?fTemp57:fSlow54));
			fRec41[0] = fRec42[0];
			int 	iTemp59 = ((fRec41[0] > 0.0f) + (1 - (fRec41[0] < 0.0f)));
			int 	iTemp60 = int((iTemp59 == 1));
			int 	iTemp61 = int((iTemp59 == 0));
			float 	fTemp62 = ((iTemp61)?1.7f:((iTemp60)?1.3f:1.0f));
			iRec43[0] = iRec39[1];
			int 	iTemp63 = int((iRec43[1] == iRec39[1]));
			int 	iTemp64 = int((iRec39[1] == 0));
			fRec44[0] = ((iTemp64)?fSlow50:((iTemp63)?min(min(fRec44[1], fSlow50), fRec40[1]):min(fSlow50, fRec40[1])));
			float 	fTemp65 = (fSlow50 * fTemp62);
			int 	iTemp66 = int((iRec39[1] == 1));
			fRec45[0] = ((iTemp64)?fSlow50:((iTemp66)?((iTemp63)?max(max(fRec45[1], fTemp65), fRec40[1]):max(fTemp65, fRec40[1])):((iTemp63)?max(max(fRec45[1], fSlow50), fRec40[1]):max(fSlow50, fRec40[1]))));
			fbargraph3 = fRec44[0];
			iRec46[0] = iRec39[1];
			iRec47[0] = ((int((iRec46[1] != iRec39[1])))?iTemp23:iRec47[1]);
			int 	iTemp67 = int((iRec39[1] >= 1));
			int 	iTemp68 = int((fSlow50 >= fRec40[1]));
			...
			fbargraph4 = ((iTemp73)?((iTemp72)?((iSlow58)?3:((iTemp68)?5:6)):((iTemp71)?((iSlow58)?3:((int((fSlow50 <= fRec40[1])))?6:5)):((int((fRec40[1] <= 0.01f)))?0:4))):((iTemp70)?((iTemp69)?((int((iSlow60 & (fRec40[1] <= 0.0f))))?0:((int((fSlow50 > fRec40[1])))?4:3)):((iTemp68)?5:iSlow59)):((iTemp67)?((int(((float((iRec22[0] + (-1 - iRec47[0]))) >= fConst33) & (fRec40[1] >= (fbargraph3 * fTemp62)))))?2:1):iSlow53)));
			iRec39[0] = fbargraph4;
			float 	fTemp74 = ((iTemp66)?fTemp65:fSlow50);
			float 	fTemp75 = ((iTemp73)?((iTemp72)?fConst0:((iTemp71)?fConst0:fConst35)):((iTemp70)?((iTemp69)?fConst0:fConst33):((iTemp67)?fConst34:0.0f)));
			float 	fTemp76 = fabsf(fRec41[0]);
			fbargraph5 = ((fTemp76 * ((iTemp61)?((iTemp73)?((iTemp72)?fConst38:((iTemp71)?fConst38:fConst35)):((iTemp70)?((iTemp69)?fConst37:fConst36):((iTemp67)?fConst36:0.0f))):((iTemp60)?fTemp75:((iTemp73)?fConst35:((iTemp70)?fConst35:((iTemp67)?fConst35:0.0f)))))) + ((1.0f - fTemp76) * fTemp75));
			...
			float 	fTemp81 = tanf((fConst32 * min((fSlow61 * (faustpower<2>((fTemp38 + (fConst31 * (fTemp80 * (1.0f - fTemp55))))) + 1.0f)), (float)16000)));
			...
			float 	fTemp88 = (fTemp87 + ((fRec50[0] - float(iTemp86)) * (ftbl0[((iTemp86 + 1) % iSlow63)] - fTemp87)));
			...
			float 	fTemp92 = tanf((fConst32 * ((fSlow68 * (fTemp89 * fTemp91)) + 200.0f)));
			...
			float 	fTemp98 = (1.0f / ((int((iSlow74 == ((fRec63[1] > 0.0f) - (fRec63[1] < 0.0f)))))?((int((fSlow72 >= fabsf(fRec63[1]))))?fConst33:fConst0):fSlow73));
			float 	fTemp99 = (fRec64[1] - fTemp98);
			float 	fTemp100 = (fRec64[1] + fTemp98);
			fRec64[0] = ((int((fTemp100 < fSlow71)))?fTemp100:((int((fTemp99 > fSlow71)))?fTemp99:fSlow71));
			fRec63[0] = fRec64[0];
			int 	iTemp101 = ((fRec63[0] > 0.0f) + (1 - (fRec63[0] < 0.0f)));
			int 	iTemp102 = int((iTemp101 == 1));
			int 	iTemp103 = int((iTemp101 == 0));
			float 	fTemp104 = ((iTemp103)?1.7f:((iTemp102)?1.3f:1.0f));
			iRec65[0] = iRec61[1];
			int 	iTemp105 = int((iRec65[1] == iRec61[1]));
			int 	iTemp106 = int((iRec61[1] == 0));
			fRec66[0] = ((iTemp106)?fSlow67:((iTemp105)?min(min(fRec66[1], fSlow67), fRec62[1]):min(fSlow67, fRec62[1])));
			float 	fTemp107 = (fSlow67 * fTemp104);
			int 	iTemp108 = int((iRec61[1] == 1));
			fRec67[0] = ((iTemp106)?fSlow67:((iTemp108)?((iTemp105)?max(max(fRec67[1], fTemp107), fRec62[1]):max(fTemp107, fRec62[1])):((iTemp105)?max(max(fRec67[1], fSlow67), fRec62[1]):max(fSlow67, fRec62[1]))));
			fbargraph6 = fRec66[0];
			iRec68[0] = iRec61[1];
			iRec69[0] = ((int((iRec68[1] != iRec61[1])))?iTemp23:iRec69[1]);
			int 	iTemp109 = int((iRec61[1] >= 1));
			int 	iTemp110 = int((fSlow67 >= fRec62[1]));
			...
			fbargraph7 = ((iTemp115)?((iTemp114)?((iSlow75)?3:((iTemp110)?5:6)):((iTemp113)?((iSlow75)?3:((int((fSlow67 <= fRec62[1])))?6:5)):((int((fRec62[1] <= 0.01f)))?0:4))):((iTemp112)?((iTemp111)?((int((iSlow77 & (fRec62[1] <= 0.0f))))?0:((int((fSlow67 > fRec62[1])))?4:3)):((iTemp110)?5:iSlow76)):((iTemp109)?((int(((float((iRec22[0] + (-1 - iRec69[0]))) >= fConst33) & (fRec62[1] >= (fbargraph6 * fTemp104)))))?2:1):iSlow70)));
			iRec61[0] = fbargraph7;
			float 	fTemp116 = ((iTemp108)?fTemp107:fSlow67);
			float 	fTemp117 = ((iTemp115)?((iTemp114)?fConst0:((iTemp113)?fConst0:fConst35)):((iTemp112)?((iTemp111)?fConst0:fConst33):((iTemp109)?fConst34:0.0f)));
			float 	fTemp118 = fabsf(fRec63[0]);
			fbargraph8 = ((fTemp118 * ((iTemp103)?((iTemp115)?((iTemp114)?fConst38:((iTemp113)?fConst38:fConst35)):((iTemp112)?((iTemp111)?fConst37:fConst36):((iTemp109)?fConst36:0.0f))):((iTemp102)?fTemp117:((iTemp115)?fConst35:((iTemp112)?fConst35:((iTemp109)?fConst35:0.0f)))))) + ((1.0f - fTemp118) * fTemp117));
			...
			float 	fTemp123 = tanf((fConst32 * min((fSlow78 * (faustpower<2>((fTemp38 + (fConst31 * (fTemp122 * (1.0f - fTemp97))))) + 1.0f)), (float)16000)));
			...
			float 	fTemp130 = (fTemp129 + ((fRec72[0] - float(iTemp128)) * (ftbl0[((iTemp128 + 1) % iSlow80)] - fTemp129)));
			...
			float 	fTemp134 = tanf((fConst32 * ((fSlow85 * (fTemp131 * fTemp133)) + 200.0f)));
			...
			float 	fTemp140 = (1.0f / ((int((iSlow91 == ((fRec85[1] > 0.0f) - (fRec85[1] < 0.0f)))))?((int((fSlow89 >= fabsf(fRec85[1]))))?fConst33:fConst0):fSlow90));
			float 	fTemp141 = (fRec86[1] - fTemp140);
			float 	fTemp142 = (fRec86[1] + fTemp140);
			fRec86[0] = ((int((fTemp142 < fSlow88)))?fTemp142:((int((fTemp141 > fSlow88)))?fTemp141:fSlow88));
			fRec85[0] = fRec86[0];
			int 	iTemp143 = ((fRec85[0] > 0.0f) + (1 - (fRec85[0] < 0.0f)));
			int 	iTemp144 = int((iTemp143 == 1));
			int 	iTemp145 = int((iTemp143 == 0));
			float 	fTemp146 = ((iTemp145)?1.7f:((iTemp144)?1.3f:1.0f));
			iRec87[0] = iRec83[1];
			int 	iTemp147 = int((iRec87[1] == iRec83[1]));
			int 	iTemp148 = int((iRec83[1] == 0));
			fRec88[0] = ((iTemp148)?fSlow84:((iTemp147)?min(min(fRec88[1], fSlow84), fRec84[1]):min(fSlow84, fRec84[1])));
			float 	fTemp149 = (fSlow84 * fTemp146);
			int 	iTemp150 = int((iRec83[1] == 1));
			fRec89[0] = ((iTemp148)?fSlow84:((iTemp150)?((iTemp147)?max(max(fRec89[1], fTemp149), fRec84[1]):max(fTemp149, fRec84[1])):((iTemp147)?max(max(fRec89[1], fSlow84), fRec84[1]):max(fSlow84, fRec84[1]))));
			fbargraph9 = fRec88[0];
			iRec90[0] = iRec83[1];
			iRec91[0] = ((int((iRec90[1] != iRec83[1])))?iTemp23:iRec91[1]);
			int 	iTemp151 = int((iRec83[1] >= 1));
			int 	iTemp152 = int((fSlow84 >= fRec84[1]));
			...
			fbargraph10 = ((iTemp157)?((iTemp156)?((iSlow92)?3:((iTemp152)?5:6)):((iTemp155)?((iSlow92)?3:((int((fSlow84 <= fRec84[1])))?6:5)):((int((fRec84[1] <= 0.01f)))?0:4))):((iTemp154)?((iTemp153)?((int((iSlow94 & (fRec84[1] <= 0.0f))))?0:((int((fSlow84 > fRec84[1])))?4:3)):((iTemp152)?5:iSlow93)):((iTemp151)?((int(((float((iRec22[0] + (-1 - iRec91[0]))) >= fConst33) & (fRec84[1] >= (fbargraph9 * fTemp146)))))?2:1):iSlow87)));
			iRec83[0] = fbargraph10;
			float 	fTemp158 = ((iTemp150)?fTemp149:fSlow84);
			float 	fTemp159 = ((iTemp157)?((iTemp156)?fConst0:((iTemp155)?fConst0:fConst35)):((iTemp154)?((iTemp153)?fConst0:fConst33):((iTemp151)?fConst34:0.0f)));
			float 	fTemp160 = fabsf(fRec85[0]);
			fbargraph11 = ((fTemp160 * ((iTemp145)?((iTemp157)?((iTemp156)?fConst38:((iTemp155)?fConst38:fConst35)):((iTemp154)?((iTemp153)?fConst37:fConst36):((iTemp151)?fConst36:0.0f))):((iTemp144)?fTemp159:((iTemp157)?fConst35:((iTemp154)?fConst35:((iTemp151)?fConst35:0.0f)))))) + ((1.0f - fTemp160) * fTemp159));
			...
			float 	fTemp165 = tanf((fConst32 * min((fSlow95 * (faustpower<2>((fTemp38 + (fConst31 * (fTemp164 * (1.0f - fTemp139))))) + 1.0f)), (float)16000)));
			...
			float 	fTemp172 = (fTemp171 + ((fRec94[0] - float(iTemp170)) * (ftbl0[((iTemp170 + 1) % iSlow97)] - fTemp171)));
			...
			float 	fTemp176 = tanf((fConst32 * ((fSlow102 * (fTemp173 * fTemp175)) + 200.0f)));
			...
			float 	fTemp182 = (1.0f / ((int((iSlow108 == ((fRec107[1] > 0.0f) - (fRec107[1] < 0.0f)))))?((int((fSlow106 >= fabsf(fRec107[1]))))?fConst33:fConst0):fSlow107));
			float 	fTemp183 = (fRec108[1] - fTemp182);
			float 	fTemp184 = (fRec108[1] + fTemp182);
			fRec108[0] = ((int((fTemp184 < fSlow105)))?fTemp184:((int((fTemp183 > fSlow105)))?fTemp183:fSlow105));
			fRec107[0] = fRec108[0];
			int 	iTemp185 = ((fRec107[0] > 0.0f) + (1 - (fRec107[0] < 0.0f)));
			int 	iTemp186 = int((iTemp185 == 1));
			int 	iTemp187 = int((iTemp185 == 0));
			float 	fTemp188 = ((iTemp187)?1.7f:((iTemp186)?1.3f:1.0f));
			iRec109[0] = iRec105[1];
			int 	iTemp189 = int((iRec109[1] == iRec105[1]));
			int 	iTemp190 = int((iRec105[1] == 0));
			fRec110[0] = ((iTemp190)?fSlow101:((iTemp189)?min(min(fRec110[1], fSlow101), fRec106[1]):min(fSlow101, fRec106[1])));
			float 	fTemp191 = (fSlow101 * fTemp188);
			int 	iTemp192 = int((iRec105[1] == 1));
			fRec111[0] = ((iTemp190)?fSlow101:((iTemp192)?((iTemp189)?max(max(fRec111[1], fTemp191), fRec106[1]):max(fTemp191, fRec106[1])):((iTemp189)?max(max(fRec111[1], fSlow101), fRec106[1]):max(fSlow101, fRec106[1]))));
			fbargraph12 = fRec110[0];
			iRec112[0] = iRec105[1];
			iRec113[0] = ((int((iRec112[1] != iRec105[1])))?iTemp23:iRec113[1]);
			int 	iTemp193 = int((iRec105[1] >= 1));
			int 	iTemp194 = int((fSlow101 >= fRec106[1]));
			...
			fbargraph13 = ((iTemp199)?((iTemp198)?((iSlow109)?3:((iTemp194)?5:6)):((iTemp197)?((iSlow109)?3:((int((fSlow101 <= fRec106[1])))?6:5)):((int((fRec106[1] <= 0.01f)))?0:4))):((iTemp196)?((iTemp195)?((int((iSlow111 & (fRec106[1] <= 0.0f))))?0:((int((fSlow101 > fRec106[1])))?4:3)):((iTemp194)?5:iSlow110)):((iTemp193)?((int(((float((iRec22[0] + (-1 - iRec113[0]))) >= fConst33) & (fRec106[1] >= (fbargraph12 * fTemp188)))))?2:1):iSlow104)));
			iRec105[0] = fbargraph13;
			float 	fTemp200 = ((iTemp192)?fTemp191:fSlow101);
			float 	fTemp201 = ((iTemp199)?((iTemp198)?fConst0:((iTemp197)?fConst0:fConst35)):((iTemp196)?((iTemp195)?fConst0:fConst33):((iTemp193)?fConst34:0.0f)));
			float 	fTemp202 = fabsf(fRec107[0]);
			fbargraph14 = ((fTemp202 * ((iTemp187)?((iTemp199)?((iTemp198)?fConst38:((iTemp197)?fConst38:fConst35)):((iTemp196)?((iTemp195)?fConst37:fConst36):((iTemp193)?fConst36:0.0f))):((iTemp186)?fTemp201:((iTemp199)?fConst35:((iTemp196)?fConst35:((iTemp193)?fConst35:0.0f)))))) + ((1.0f - fTemp202) * fTemp201));
			...
			float 	fTemp207 = tanf((fConst32 * min((fSlow112 * (faustpower<2>((fTemp38 + (fConst31 * (fTemp206 * (1.0f - fTemp181))))) + 1.0f)), (float)16000)));
			...
			float 	fTemp214 = (fTemp213 + ((fRec116[0] - float(iTemp212)) * (ftbl0[((iTemp212 + 1) % iSlow114)] - fTemp213)));
			...
			float 	fTemp218 = tanf((fConst32 * ((fSlow119 * (fTemp215 * fTemp217)) + 200.0f)));
			...
			float 	fTemp224 = (1.0f / ((int((iSlow125 == ((fRec129[1] > 0.0f) - (fRec129[1] < 0.0f)))))?((int((fSlow123 >= fabsf(fRec129[1]))))?fConst33:fConst0):fSlow124));
			float 	fTemp225 = (fRec130[1] - fTemp224);
			float 	fTemp226 = (fRec130[1] + fTemp224);
			fRec130[0] = ((int((fTemp226 < fSlow122)))?fTemp226:((int((fTemp225 > fSlow122)))?fTemp225:fSlow122));
			fRec129[0] = fRec130[0];
			int 	iTemp227 = ((fRec129[0] > 0.0f) + (1 - (fRec129[0] < 0.0f)));
			int 	iTemp228 = int((iTemp227 == 1));
			int 	iTemp229 = int((iTemp227 == 0));
			float 	fTemp230 = ((iTemp229)?1.7f:((iTemp228)?1.3f:1.0f));
			iRec131[0] = iRec127[1];
			int 	iTemp231 = int((iRec131[1] == iRec127[1]));
			int 	iTemp232 = int((iRec127[1] == 0));
			fRec132[0] = ((iTemp232)?fSlow118:((iTemp231)?min(min(fRec132[1], fSlow118), fRec128[1]):min(fSlow118, fRec128[1])));
			float 	fTemp233 = (fSlow118 * fTemp230);
			int 	iTemp234 = int((iRec127[1] == 1));
			fRec133[0] = ((iTemp232)?fSlow118:((iTemp234)?((iTemp231)?max(max(fRec133[1], fTemp233), fRec128[1]):max(fTemp233, fRec128[1])):((iTemp231)?max(max(fRec133[1], fSlow118), fRec128[1]):max(fSlow118, fRec128[1]))));
			fbargraph15 = fRec132[0];
			iRec134[0] = iRec127[1];
			iRec135[0] = ((int((iRec134[1] != iRec127[1])))?iTemp23:iRec135[1]);
			int 	iTemp235 = int((iRec127[1] >= 1));
			int 	iTemp236 = int((fSlow118 >= fRec128[1]));
			...
			fbargraph16 = ((iTemp241)?((iTemp240)?((iSlow126)?3:((iTemp236)?5:6)):((iTemp239)?((iSlow126)?3:((int((fSlow118 <= fRec128[1])))?6:5)):((int((fRec128[1] <= 0.01f)))?0:4))):((iTemp238)?((iTemp237)?((int((iSlow128 & (fRec128[1] <= 0.0f))))?0:((int((fSlow118 > fRec128[1])))?4:3)):((iTemp236)?5:iSlow127)):((iTemp235)?((int(((float((iRec22[0] + (-1 - iRec135[0]))) >= fConst33) & (fRec128[1] >= (fbargraph15 * fTemp230)))))?2:1):iSlow121)));
			iRec127[0] = fbargraph16;
			float 	fTemp242 = ((iTemp234)?fTemp233:fSlow118);
			float 	fTemp243 = ((iTemp241)?((iTemp240)?fConst0:((iTemp239)?fConst0:fConst35)):((iTemp238)?((iTemp237)?fConst0:fConst33):((iTemp235)?fConst34:0.0f)));
			float 	fTemp244 = fabsf(fRec129[0]);
			fbargraph17 = ((fTemp244 * ((iTemp229)?((iTemp241)?((iTemp240)?fConst38:((iTemp239)?fConst38:fConst35)):((iTemp238)?((iTemp237)?fConst37:fConst36):((iTemp235)?fConst36:0.0f))):((iTemp228)?fTemp243:((iTemp241)?fConst35:((iTemp238)?fConst35:((iTemp235)?fConst35:0.0f)))))) + ((1.0f - fTemp244) * fTemp243));
			...
			float 	fTemp249 = tanf((fConst32 * min((fSlow129 * (faustpower<2>(((fConst31 * (fTemp248 * (1.0f - fTemp223))) + fTemp38)) + 1.0f)), (float)16000)));
			...
			fRec0[0] = ((fConst53 * ((((((fTemp248 * (((fRec125 * faustpower<2>((1.0f - (0.5f * fTemp223)))) + (fSlow120 * ((fRec122 * fTemp215) * fTemp217))) + (6.0f * ((fSlow30 * ((fSlow23 * (fRec118[0] - fRec118[2])) / fSlow27)) + (0.125f * ((fSlow21 * ((fSlow14 * (fRec117[0] - fRec117[2])) / fSlow18)) + (fSlow12 * ((fSlow1 * (fRec115[0] - fRec115[2])) / fSlow5)))))))) + (fTemp206 * (((fRec103 * faustpower<2>((1.0f - (0.5f * fTemp181)))) + (fSlow103 * ((fRec100 * fTemp173) * fTemp175))) + (6.0f * ((fSlow30 * ((fSlow23 * (fRec96[0] - fRec96[2])) / fSlow27)) + (0.125f * ((fSlow21 * ((fSlow14 * (fRec95[0] - fRec95[2])) / fSlow18)) + (fSlow12 * ((fSlow1 * (fRec93[0] - fRec93[2])) / fSlow5))))))))) + (fTemp164 * (((fRec81 * faustpower<2>((1.0f - (0.5f * fTemp139)))) + (fSlow86 * ((fRec78 * fTemp131) * fTemp133))) + (6.0f * ((fSlow30 * ((fSlow23 * (fRec74[0] - fRec74[2])) / fSlow27)) + (0.125f * ((fSlow21 * ((fSlow14 * (fRec73[0] - fRec73[2])) / fSlow18)) + (fSlow12 * ((fSlow1 * (fRec71[0] - fRec71[2])) / fSlow5))))))))) + (fTemp122 * (((fRec59 * faustpower<2>((1.0f - (0.5f * fTemp97)))) + (fSlow69 * ((fRec56 * fTemp89) * fTemp91))) + (6.0f * ((fSlow30 * ((fSlow23 * (fRec52[0] - fRec52[2])) / fSlow27)) + (0.125f * ((fSlow21 * ((fSlow14 * (fRec51[0] - fRec51[2])) / fSlow18)) + (fSlow12 * ((fSlow1 * (fRec49[0] - fRec49[2])) / fSlow5))))))))) + (fTemp80 * (((fRec37 * faustpower<2>((1.0f - (0.5f * fTemp55)))) + (fSlow52 * ((fRec34 * fTemp47) * fTemp49))) + (6.0f * ((fSlow30 * ((fSlow23 * (fRec30[0] - fRec30[2])) / fSlow27)) + (0.125f * ((fSlow21 * ((fSlow14 * (fRec29[0] - fRec29[2])) / fSlow18)) + (fSlow12 * ((fSlow1 * (fRec27[0] - fRec27[2])) / fSlow5))))))))) + (fTemp37 * (((fRec11 * faustpower<2>((1.0f - (0.5f * fTemp11)))) + (fSlow34 * ((fRec8 * fTemp3) * fTemp5))) + (6.0f * ((fSlow30 * ((fSlow23 * (fRec4[0] - fRec4[2])) / fSlow27)) + (0.125f * ((fSlow21 * ((fSlow14 * (fRec3[0] - fRec3[2])) / fSlow18)) + (fSlow12 * ((fSlow1 * (fRec1[0] - fRec1[2])) / fSlow5)))))))))) - (fConst8 * ((fConst6 * fRec0[2]) + (fConst4 * fRec0[1]))));
